...
const Navbar = () => {
  ...
  return (
    ...
    //       </ul>
    //       {!false ?
    //         <div className="d-flex justify-content-evenly mt-sm-4 mt-md-4 mt-lg-0 mt-xl-0 mt-xxl-0">
    ...
    //         </div>
    //         :
    //         <div className="d-flex justify-content-between mt-sm-4 mt-md-4 mt-lg-0 mt-xl-0 mt-xxl-0">
    //           <li className="nav-item">
